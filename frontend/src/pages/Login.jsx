        ...
        <div style={s.page}>
            <div style={s.left}>
                <div style={s.leftContent}>
                    ...
                    <p style={s.brandTagline}>Banking at the speed of thought</p>
                    <div style={s.features}>
                        {['Instant transfers', 'Real-time fraud detection', 'Smart notifications', 'Enterprise security'].map(f => (
            ...
            <div style={s.right}>
                <div style={s.card}>
                    ...
                    <p style={s.subtitle}>Welcome back to SwiftBank</p>
                    ...
                    <p style={s.link}>
                        No account? <Link to="/register" style={s.linkA}>Register</Link>
                    </p>
                </div>
            </div>
        </div>
